...
test('carrega estado, Supabase e interface na ordem necessária', () => {
    ...
    assert.ok(estadoIdx >= 0 && estadoIdx < compartilhadoIdx && compartilhadoIdx < apiIdx && apiIdx < financeiroIdx && financeiroIdx < dadosUiIdx && dadosUiIdx < tabelasIdx && tabelasIdx < visoesIdx && visoesIdx < interacoesIdx && interacoesIdx < graficosIdx && graficosIdx < formularioIdx && formularioIdx < bootstrapIdx);
});
