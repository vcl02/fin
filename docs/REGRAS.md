...
- Erros operacionais usam toast, sem interromper a tela com `alert()`. A única caixa nativa permitida é a confirmação antes de excluir um lançamento real ou simulado, porque essa ação não pode ser desfeita.
