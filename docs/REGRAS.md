...
- No cadastro, Nome é texto livre. O campo oferece uma lista de nomes distintos já usados, exibindo a categoria da ocorrência mais recente; ao escolher ou digitar um nome conhecido, a categoria é apenas sugerida e continua editável. Nome sem correspondência é aceito normalmente.
